...
require "./data/current_combinations_array_create"
...
class GuestsToSeats
  ...
  def print_results
      ...
      @guests_hash = Data::GuestsToHashFirstMeal.new(tables_number, seats_number, guests_array).hash_create
      Data::CalculateSecondMeal.new(seats_number, guests_hash).hash_update
      @combinations_array = Data::CurrentCombinationsArrayCreate.new(guests_hash).generate_combinations_array
      Data::CalculateThirdMeal.new(combinations_array, guests_array, guests_hash, tables_number, seats_number, comparator).hash_update
